    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div class="flex items-center gap-4">
        <div class="sm:flex sm:gap-4">
          <a class="block rounded-md bg-yellow-400 px-5 py-2.5 text-sm font-medium text-black transition hover:bg-yellow-300" href="#"> Login </a>

          <a class="hidden rounded-md bg-white px-5 py-2.5 text-sm font-medium text-black transition hover:bg-black transition hover:text-white sm:block" href="#"> Register </a>
        </div>
